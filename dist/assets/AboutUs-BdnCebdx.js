import{b as o,j as e}from"./index-CchdiQHP.js";import{b as n,M as r,T as t}from"./text-card-BM398NW_.js";import{C as s,F as a}from"./footer-DRQUDquF.js";const c=()=>{const i=o();return e.jsx(s,{children:e.jsxs("div",{className:"grid  ",children:[e.jsx("img",{src:n,className:"mx-auto pt-11 pb-7 "}),e.jsxs("div",{className:"flex",children:[e.jsxs("button",{className:"bg-[#905E5E33] h-fit p-4 text-white rounded-lg flex items-center gap-3 ",onClick:()=>i("/"),children:[e.jsx(r,{})," Back to Home page"]}),e.jsxs("div",{className:" max-h-[600px] px-5 py-3 max-w-[900px] rounded-xl bg-white  mx-auto custom-scrollbar",children:[e.jsx(t,{title:"About Us",description:`At Bible Interpretation AI, we are committed to bringing the
              ...
              our AI system is here to assist you every step of the way.`}),e.jsx(t,{title:"Our Mission",description:`We believe that understanding the Word of God is a powerful tool
              ...
              your faith journey.`}),e.jsx(t,{title:"Why We Built Bible Interpretation AI",description:`In today’s fast-paced world, many people struggle to find time for
              ...
              teachings more deeply.`}),e.jsx(t,{title:"How It Works",description:`Our AI-powered platform uses advanced natural language processing
              ...
              God’s Word.`})]})]}),e.jsx(a,{})]})})};export{c as default};
